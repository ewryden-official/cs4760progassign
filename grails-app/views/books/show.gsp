...
<html>
    ...
    <body>
        ...
        <div id="show-books" class="content scaffold-show" role="main">
            ...
            <f:display bean="books" />
            <g:form resource="${this.books}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.books}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
